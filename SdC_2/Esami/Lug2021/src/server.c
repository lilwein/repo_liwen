...
int main(int argc, char *argv[])
{
	...
	listening_socket_desc = socket(AF_INET, STREAM_SOCK, 0);
     ...
     */
	 ...
	 bind(listening_socket_desc, (struct sockaddr*) &server_addr, (socklen_t) sockaddr_len);
	 listen(listening_socket_desc, MAX_CONN_QUEUE);
	 accept(listening_socket_desc, (struct sockaddr *) &client_addr, (socklen_t *)&sockaddr_len);
